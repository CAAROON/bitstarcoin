...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1503468000, vin, vout, 0);
        ...
        assert(hashGenesisBlock == uint256("0x00000a070895a3179065b7c8aa1ca794b2e5a06db5bec55b964ac495985085fd"));
        assert(genesis.hashMerkleRoot == uint256("0x10b19e6c172f259d81cb2935e10033dd70e4eebad00d104a7807d1a09599c51e"));
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 233903;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000cdea654056f131dc28e7631ac9e6128d04ad41ac38f87f53cc3a5efcf500"));
...
public:
    CRegTestParams() {
        ...
        nDefaultPort = 19666;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x30208409af8d3fee3f6ff0c4d17c36a1790a32cecb4c2aa3bafe718b903a0b95"));
